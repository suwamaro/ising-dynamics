...
#ifndef _SQUARE_LATTICE1_2_
#define _SQUARE_LATTICE1_2_
...
namespace Lattice {
  ...
  public:
    ...
    template<class T> static std::vector<T> make_2by1_state(std::size_t N, T up, T down);
    template<class T> static std::vector<T> make_2by2_state(std::size_t N, T up, T down);    
    template<class T> static std::vector<T> make_4by2_state(std::size_t N, T up, T down);
    template<class T> static std::vector<T> make_4by4_state(std::size_t N, T up, T down);
  ...
  template<class T> std::vector<T> SquareLattice::make_2by1_state(std::size_t N, T up, T down){
  ...
  template<class T> std::vector<T> SquareLattice::make_4by2_state(std::size_t N, T up, T down){
    std::vector<T> spins(N);
    std::size_t L = (std::size_t)(round(sqrt(N)));
    assert(N == L * L);   // Isotropic system
    for(std::size_t s=0; s < N; s++){
  ...
  template<class T> std::vector<T> SquareLattice::make_4by4_state(std::size_t N, T up, T down){
    std::vector<T> spins(N);
    std::size_t L = (std::size_t)(round(sqrt(N)));
    assert(N == L * L);   // Isotropic system  
    for(std::size_t s=0; s < N; s++){
