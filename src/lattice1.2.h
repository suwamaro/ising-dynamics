...
inline int get_bit(int a, std::size_t di){
  return (a >> di) & 1;
}
...
namespace Lattice {
  ...
  public:
    ...
    virtual std::size_t n_neighbors(std::size_t d, std::size_t i) const;    
    virtual std::size_t n_neighbors_plaquette(std::size_t i) const;
    virtual std::size_t n_neighbors_plaquette(std::size_t i, std::size_t j) const;
    virtual std::size_t get_neighbor(std::size_t d, std::size_t i, std::size_t j) const;        
    virtual std::size_t get_neighbor_plaquette(std::size_t i, std::size_t j, std::size_t k) const;        
    virtual std::vector<std::size_t>::const_iterator neighbor_ptr(std::size_t) const { return neighbors_[0][0].begin(); }
